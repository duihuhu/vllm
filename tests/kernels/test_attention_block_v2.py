...
def run_new_single_query_cached_kv_attention(v) -> None:
    ...
    if v == 1:
        ...
        for i in range(10):
            ...
            block_tables_tensor = torch.tensor([[0, 1, 2 ,3], [4, 5, 9, 9], [6, 7, 8, 9]], dtype=torch.int, device='cuda')
            ...
            block_tables_tensor2 = torch.tensor([[0, 1, 2 ,3], [4, 5, 9, 9], [6, 7, 8, 9]], dtype=torch.int, device='cuda')
