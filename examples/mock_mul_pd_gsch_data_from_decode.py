...
total_requests = 64
# batch_size = 4
requestIds_event = manager.Event()
request_ids = []
...
@app.post("/mdecode_requestIds")
async def recevice_request_ids(request: Request) -> Response:
    global requestIds_event
    global request_ids
    request_dict = await request.json()
    request_ids =  request_dict.pop("request_ids")
    print("request_ids from decode", request_ids)
    requestIds_event.set()
