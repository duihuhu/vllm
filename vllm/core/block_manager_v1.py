...
class BlockSpaceManagerV1(BlockSpaceManager):
    ...
    def allocate_radix_cache(self, seq_group: SequenceGroup) -> None:
        ...
        if value: 
            ...
            s_prefix_len = 0
        print("s_prefix_len ", s_prefix_len, num_prompt_blocks, last_node.parent, last_node.value)
        ...
        if seq.last_node.parent == None:
            ...
            prefix_len, last_node = self.gpu_allocator.insert_radix_cache_on_node(seq.last_node, tensor_token_ids[seq.prefix_len:], block_table[s_prefix_len:num_prompt_blocks])
