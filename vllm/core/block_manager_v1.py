    ...
    def allocate_radix_cache(self, seq_group: SequenceGroup) -> None:
        ...
        if seq.last_node == self.gpu_allocator.radix_cache.root_node \
            ...
            if pre_prefix_len <= num_prompt_blocks:
                ...
                prefix_len, last_node = self.gpu_allocator.insert_radix_cache_on_node(seq.last_node.parent.parent, radix_token_ids[(pre_prefix_len-seq.last_matched_len):], block_table[(pre_prefix_len-seq.last_matched_len):])
