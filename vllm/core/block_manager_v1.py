...
class BlockSpaceManagerV1(BlockSpaceManager):
    ...
    def allocate_radix_cache(self, seq_group: SequenceGroup) -> None:
        ...
        if seq.last_node == self.gpu_allocator.radix_cache.root_node \
            ...
            prefix_len, last_node = self.gpu_allocator.insert_radix_cache(seq.last_node, radix_token_ids[(pre_prefix_len-seq.last_matched_len):], block_table[(pre_prefix_len-seq.last_matched_len):])
            seq.prefix_len = prefix_len + prefix_len
            seq.last_node = last_node
