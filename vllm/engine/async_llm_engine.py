...
class _AsyncLLMEngine(LLMEngine):
    ...
    async def trans_kv_step_aysnc(self) -> None:
        ...
        for worker_finished_tasks in finished_tasks:
            ...
            real_send_finished_req_ids, real_recv_finished_req_ids = self.send_kv_trans_scheduler.add_finished_tasks(send_finished_tasks)
        ...
        for worker_finished_tasks in finished_tasks:
            ...
            real_send_finished_req_ids, real_recv_finished_req_ids = self.recv_kv_trans_scheduler.add_finished_tasks(recv_finished_tasks)
