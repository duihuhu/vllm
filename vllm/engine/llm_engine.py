...
class LLMEngine:
    ...
    def add_mprefill_request(
        ...
        self.scheduler.add_mprefill_seq_group(seq_group)
    ...
    def has_unfinished_decode_requests(self) -> bool:
        return self.scheduler.has_unfinished_decode_requests()
    ...
    def step(self) -> List[RequestOutput]:
        ...
        for seq_group in seq_groups + ignored_seq_groups:
            ...
            print("first token time ", self.first_token_output[request_output.request_id])
