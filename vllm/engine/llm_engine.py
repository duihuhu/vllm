...
class LLMEngine:
    ...
    def __init__(
        ...
        self.kv_trans_scheduler = KvTransScheduler(self.parallel_config.tensor_parallel_size, deploy_config.enable_layer)
        ...
        self.scheduler = Scheduler(scheduler_config, cache_config, deploy_config, lora_config, tensor_parallel_size)
