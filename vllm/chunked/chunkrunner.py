...
class ChunkRunner:
    ...
    def _add_requests_to_self(self) -> None:
        ...
        prompt_lens = [91, 88, 75, 966, 3, 2047, 42, 103, 15, 717, 1589, 385, 49, 306, 228, 315, 21, 104, 30, 182, 
                       ...
                       308, 60, 100, 49, 871, 30, 122, 75, 89, 76, 42, 62, 59, 104, 955, 505, 191, 88, 61, 592, 273, 
                       497, 308, 385, 80, 878, 228, 53, 2047, 15]
    ...
    def _reduce_outputs(self) -> None:
        ...
        for chunk in self.all_job_chunks[0: self.chunk_num]:
