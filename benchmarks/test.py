...
# 基础命令模板
base_command = "CUDA_VISIBLE_DEVICES=6,7 python3 benchmark_latency.py --input-len {x} --ratio {y} --use-agg-block --enable-radix-caching --file-name /home/jovyan/hhy/vllm-hhy/benchmarks/log2_{x}_{y}.txt"
