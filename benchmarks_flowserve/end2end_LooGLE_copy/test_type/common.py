...
async def post_request_and_get_response(args, req, waiting_time, main_request_id=None):
...
async def dummy_post_request_and_get_response(args, req, waiting_time, main_request_id=None, sub_request_id=None):
